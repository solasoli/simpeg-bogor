...
<div class="panel panel-default">
	<div class="panel-heading hidden-print">
		<div class="panel-title">
			<h5>DAFTAR NOMINATIF</h5>
		</div>
	</div>
	<div class="visible-print">
		<h5 class="text-center">MENU UNDUH<br> DAFTAR NOMINATIF 2017</h5>
	</div>
	...
	<div class="panel-body">
		<div class="form-group">
			...
			<select id="skpd" class="form-control">
				...
				<?php
					$skpds = $uk->get_skpd_list_tahun(2017);
	...
	<div class="panel-footer">
		<button id="btnDUK" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-save"></span> UNDUH NOMINATIF</button>
	</div>
</div>
<div id="content"></div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		if(opd == 0){
			...
			*/
			window.open("<?php echo BASE_URL.'admin/nominatif_table.php'?>","_blank");
		}else{

			id_unit_kerja = $("#unit_kerja").val();

			if(id_unit_kerja == 0){
				window.open("<?php echo BASE_URL.'admin/nominatif_table.php?opd='?>"+opd,"_blank");
			}else{
				window.open("<?php echo BASE_URL.'admin/nominatif_table.php?opd='?>"+opd+"&uk="+id_unit_kerja,"_blank");
			}

    ...
    <div class="TabbedPanelsContent">
      <table width="100%" border="0" cellpadding="3" cellspacing="0" class="hurup">
        ...
        <tr>
          ...
          <td>:</td>
          <td><input name="twin" type="text" id="twin" value="<? echo($ata['tempat_lahir_istri']); ?>" size="35" /></td>
          </tr>
        <tr>
      ...
      <table width="100%" border="0" cellpadding="3" cellspacing="0" class="hurup">
        ...
        <div class="TabbedPanelsContent">
          <table width="100%" border="0" cellpadding="3" cellspacing="0" class="hurup">
            ...
            <?
			$k=1;
			$qsk=mysql_query("select * from sk where id_pegawai=$id order by tmt desc, id_kategori_sk");
			while($cu=mysql_fetch_array($qsk))
			{
              ...
              <td><input type=text nama=tgsk$k id=tgsk$k value=$tsk1-$bsk1-$thsk1 class=tcal size=8 /></td>
				...
				<td nowrap> <input type=text nama=nosk$k id=nosk$k value='$cu[3]' size=30 class=hurup /> </td>

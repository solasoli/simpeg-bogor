        ...
        <?php foreach ($dataManual as $lsdata2) { ?>
            <div style="width: 98%;font-size: 10pt;line-height: 1.5; margin-top: 10px;">
                ...
                <?php if($lsdata2->methode=='GET'): ?>
                    <br><strong>URL : </strong><small><?php echo smart_wordwrap('http://simpeg.kotabogor.go.id/rest/'.$lsdata2->entitas.'/exec_running_methode/'.$lsdata2->id_methode.'/{API Key}/{Param1 (optional)}/{Param2 (optional)}',140);?></small>
                    <br><br>
                <?php else: ?>

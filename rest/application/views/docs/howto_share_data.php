        ...
        <div class="col-sm-12">
            ...
            <ul>
                ...
                <li>
                    ...
                    <strong>GET</strong> : <code>https://simpeg.kotabogor.go.id/rest/{entitas}/exec_running_methode/{ID Methode}/{API Key}/{param1}/{param2}</code> <br>
                    ...
                    <br><strong>POST</strong> : <code>https://simpeg.kotabogor.go.id/rest/{entitas}/exec_running_methode/{ID Methode}</code> <br>

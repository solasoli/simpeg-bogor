...
?>
  ...
  <input type="hidden" name="x" value="fir.php" id="x" />
...
{
$cari=date("$tahun-").$ru;
$qir=mysqli_query($link,"select nama,nip_baru,status_aktif,nama_baru,pegawai.id_pegawai from pegawai inner join current_lokasi_kerja on pegawai.id_pegawai = current_lokasi_kerja.id_pegawai inner join unit_kerja on unit_kerja.id_unit_kerja = current_lokasi_kerja.id_unit_kerja where flag_pensiun=1 and tgl_pensiun_dini like '$cari%' and status_aktif not like 'pindah%' order by tgl_pensiun_dini");

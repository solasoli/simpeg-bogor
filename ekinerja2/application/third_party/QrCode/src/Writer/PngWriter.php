...
class PngWriter extends AbstractWriter
{
    ...
    private function addMargin($sourceImage, $margin, $size, array $foregroundColor, array $backgroundColor)
    {
    ...
    private function calculateAdditionalWhiteSpace($image, array $foregroundColor)
    {
        $width = imagesx($image);
    ...
    private function addLogo($sourceImage, $logoPath, $logoWidth = null)
    {
    ...
    private function addLabel($sourceImage, $label, $labelFontPath, $labelFontSize, $labelAlignment, array $labelMargin, array $foregroundColor, array $backgroundColor)
    {

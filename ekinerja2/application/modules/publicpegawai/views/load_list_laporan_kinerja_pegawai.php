...
<script>
    function fnCetakLaporan(id_knj_master_enc){
        window.open('/ekinerja2/publicpegawai/cetak_laporan_kinerja_pegawai/' + id_knj_master_enc, '_blank');
    }

    function fnCetakAktifitas(id_knj_master_enc){
        window.open('/ekinerja2/publicpegawai/cetak_laporan_kinerja_pegawai_aktifitas/' + id_knj_master_enc, '_blank');
    }
</script>
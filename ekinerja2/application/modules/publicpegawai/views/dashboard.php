...
<div class="panel-content" data-role="panel"
    ...
    <div class="row mt-2">
        <div class="cell-md-6">
            ...
            <div class="card">
                <div class="card-header"
                     style="background-image: url(<?php echo base_url('assets/images/grey1.jpg'); ?>)">Kinerja Bulan Ini
                </div>
                <div class="card-content p-2">
                    ...
                    <?php if (isset($kinerja_curr) and sizeof($kinerja_curr) > 0 and $kinerja_curr != '') { ?>
                        <?php foreach ($kinerja_curr as $lsdata): ?>
                            ...
                            Komp. Kinerja (60%) : Rp. <?php echo number_format($lsdata->rupiah_awal_kinerja, 0, ",", "."); ?>,-
                            <br>
                            Komp. Disiplin (40%) : Rp. <?php echo number_format($lsdata->rupiah_awal_disiplin, 0, ",", "."); ?>,-
                            <br>
                            ...
                            Tunjangan Kinerja : Rp. <?php echo number_format($lsdata->rupiah_kinerja_aktual, 0, ",", "."); ?>,-
                            <br>
                            % Kedisiplinan : <?php echo $lsdata->last_persen_disiplin; ?>%<br>
                            Tunjangan Kedisiplinan : Rp. <?php echo number_format($lsdata->last_rupiah_disiplin, 0, ",", "."); ?>,-
                            <br>
                ...
                <?php if (isset($lsdata->id_knj_master) and $lsdata->id_knj_master != ''): ?>
                    <!-- ini cek kalo bulan baru belom ada ekin jadi error -->
                    <div class="card-footer">
                        <button onclick="detail_laporan_kinerja('<?php echo $lsdata->id_knj_master; ?>')"
                                class="button primary bg-darkSteel small rounded">
                            <span class="mif-note icon"></span> Detail
                        </button>
                    </div>
                <?php endif; ?>
                <!-- end of error -->
        ...
        <div class="cell-md-6">
            <div class="card">
                <div class="card-header"
                     style="background-image: url(<?php echo base_url('assets/images/grey1.jpg'); ?>)">Status Aktifitas
                </div>
                <div class="card-content p-2">
            ...
            <?php if (isset($last_eselon) and $last_eselon != ''): ?>
                <div class="card">
                    <div class="card-header"
                         style="background-image: url(<?php echo base_url('assets/images/grey1.jpg'); ?>)">Status Aktifitas Staf
                    </div>
                    <div class="card-content p-2">
                        <?php
                        $statusAktStaf = $this->ekinerja->get_status_aktifitas_current_stafnya($this->session->userdata('id_pegawai_enc'), $this->session->userdata('id_skpd_enc'));
                        if (isset($statusAktStaf) and sizeof($statusAktStaf) > 0 and $statusAktStaf != '') {
                            ?>
                            <table class="table compact row-border"
                                   style="border-bottom: 1px solid rgba(71,71,72,0.35);">
                                <thead>
                                <tr>
                                    <td>No</td>
                                    <td>Nama Staf</td>
                                ...
                                $total = 0;
                                ?>
                                <?php foreach ($statusAktStaf as $lsdata3): ?>
                                    <tr style="text-align: center;">
                                        <td style="vertical-align: top;"><?php echo $i; ?>.</td>
                                        <td style="text-align: left;vertical-align: top;"><?php echo $lsdata3->nama; ?></td>
                                        <td style="vertical-align: top;"><?php echo $lsdata3->blm_diproses; ?></td>
                                        <td style="vertical-align: top;"><?php echo $lsdata3->disetujui; ?></td>
                                        <td style="vertical-align: top;"><?php echo $lsdata3->revisi; ?></td>
                                        <td style="vertical-align: top;"><?php echo $lsdata3->ditolak; ?></td>
                                        <td style="vertical-align: top;"><?php echo($lsdata3->blm_diproses + $lsdata3->disetujui + $lsdata3->revisi + $lsdata3->ditolak); ?></td>
                                    </tr>
                                    <?php
                                    $i++;
                                    $blm_diproses = $blm_diproses + $lsdata3->blm_diproses;
                                    $disetujui = $disetujui + $lsdata3->disetujui;
                                    $revisi = $revisi + $lsdata3->revisi;
                                    $ditolak = $ditolak + $lsdata3->ditolak;
                                    $total = $total + ($lsdata3->blm_diproses + $lsdata3->disetujui + $lsdata3->revisi + $lsdata3->ditolak);
                                    ?>
                                <?php endforeach; ?>
                                <tr>
                                    <td></td>
                                    <td>Total</td>
                                    <td><?php echo $blm_diproses; ?></td>

...
<div class="panel-content" data-role="panel"
    ...
    <ul class="tabs-expand-md" data-role="tabs" style="font-size: small;font-weight: bold;" data-on-tab="tab_jadwal_click">
        <li id="tbInputJadwal" <?php echo($tab=='tbInputJadwal'?'class="active"':'') ?>><a href="#tab1">Formulir</a></li>
        <li id="tbListJadwal" <?php echo($tab=='tbListJadwal'?'class="active"':'') ?>><a href="#tab2">Daftar Jadwal</a></li>
        <li id="tbDetailJadwal" <?php echo($tab=='tbDetailJadwal'?'class="active"':'') ?>><a href="#tab3">Daftar Detail Jadwal</a></li>
    </ul>

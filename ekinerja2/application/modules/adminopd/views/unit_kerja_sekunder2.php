...
<div class="panel-content" data-role="panel"
    ...
    <div class="border bd-default no-border-top p-2">
        <div id="tab1">
            <?php if (isset($list_uk_sekunder) and sizeof($list_uk_sekunder) > 0 and $list_uk_sekunder != ''){ ?>
                <div class="row mb-2">
                    <div class="cell-md-8 my-search-wrapper2"></div>
                    <div class="cell-md-4 my-rows-wrapper2"></div>
                </div>
                <div style="overflow-x: auto;">
                    <table id="tblUkSekunder" class="table row-hover row-border compact"
                           ...
                           data-search-wrapper=".my-search-wrapper2"
                           data-rows-wrapper=".my-rows-wrapper2">
                        <thead>
                        <tr>
                            <th>No</th>
                            <th>Unit Sekunder</th>
                        ...
                        <?php $i = 1; ?>
                        <?php foreach ($list_uk_sekunder as $lsdata): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <small>Koordinat:<br>
                                        <img src='<?php echo base_url('assets/images/green-dot.png');?>' style="width:16px;height: 16px;"/> Dalam: <?php echo $lsdata->in_lat; ?>, <?php echo $lsdata->in_long; ?><br>

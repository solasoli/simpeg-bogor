 ...
 **************************************************************************/
	...
	$tcpdf['base_url'] .= preg_replace('@/+$@','',dirname($_SERVER['SCRIPT_NAME'])).'/'; 
	$tcpdf['base_url'] .= '/3rdparty/tcpdf/';
 ...
 **************************************************************************/
	...
	$tcpdf['creator'] = 'rommonz';
	$tcpdf['author'] = 'rommonz';
	...
	$tcpdf['header_title'] = 'Badan Kepegawaian, Pendidikan, dan Pelatihan Kota Bogor';
	$tcpdf['header_string'] = "";
	$tcpdf['header_logo'] = 'Farrasindo_jpg.jpg';
	$tcpdf['header_logo_width'] = 25;

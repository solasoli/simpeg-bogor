    ...
    <table class="table bordered striped" id="lst_data">
        ...
        <?php if (sizeof($list_data) > 0): ?>
            ...
            <tr>
                ...
                <td width="15%">
                    <a href="<?php echo base_url('index.php/phpexcel/excel_ipp_asn/index/').'/'.$lsdata->id_unit_kerja ?>" class="button bg-darkBlue fg-white" target="_blank">Download Excel IPP</a>
                </td>
            </tr>
        <?php $i++; ?>
        <?php endforeach; ?>

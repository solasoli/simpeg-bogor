                    ...
                    <tr>
                        ...
                        <td style="width:40%">
                            ...
                            foreach($dataRowPengesah as $data) {
                                ...
                                $is_plh = (isset($data->id_pegawai_plh)==''?0:1);
                            }
                            ...
                            <?php else: ?>
                                ...
                                <?php elseif($eselon=='IIIB'):?>
                                    ...
                                    <?php
                                        if($last_gol >= 'III/a' and $last_gol <= 'IV/a'){
                                            if($is_plt==0) {?>
                                                <span style="margin-left: -30px;">a.n. </span><strong>Kepala</strong><br>
                                                <?php echo "<strong>".($is_plt==1?'Plt. ':'').($is_plh==1?'Plh. ':'')."Sekretaris,</strong>";
                                                if($is_plh==1){
                                                    echo "<br>";
                                                    //echo "<span style=\"margin-left: 20px;\">u.b.</span><br>";
                                                    echo '<strong>'.ucfirst(substr($jabatan,0,strpos($jabatan,' pada'))).'</strong>,';
                                            ...
                                            if($is_plt==0) {?>
                                                <span style="margin-left: -30px;">a.n. </span><strong>Kepala</strong><br>
                                                <strong><?php echo ($is_plt==1?'Plt. ':'').($is_plh==1?'Plh. ':''); ?>Sekretaris</strong>,<br>
                                ...
                                <?php else: ?>
                                    ...
                                    ?>
                                <?php if($last_gol >= 'III/a' and $last_gol <= 'IV/a'){ ?>
                        ...
                        <td style="width:60%; text-align: left; vertical-align: top;">
                            ...
                            <ol style="margin-left: -20px;margin-top: -10px;">
                                ...
                                <?php else: ?>
                                    ...
                                    <?php else: ?>
                                        <?php if(strpos($unit, 'Bagian') !== false): ?>
                                        <?php else: ?>
                                ...
                                <?php elseif ((strpos($unit, 'Kelurahan') !== false) and (strpos($jabatan_p, 'Lurah') !== 0)): ?>
                                    <li>Lurah <?php echo substr($unit, strpos($unit, 'Kelurahan')+10,strlen($unit)) ?>;</li>
                                <?php elseif (strpos($unit, 'Kelurahan') !== false and strpos($jabatan_p, 'Lurah') !== false): ?>
...
try
{
    ...
    $html2pdf->Output('surat_cuti_bkpsda.pdf');

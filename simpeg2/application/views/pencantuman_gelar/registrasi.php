<?php $landing = "pencantuman_gelar/registrasi"; ?>
...
<?php if($pegawai != null): ?>
<?php echo form_open('pencantuman_gelar/save'); ?>
<fieldset>
...
<fieldset>
	...
	<?php if(isset($riwayat_pendidikan)): ?>	
	<table class="table striped">
		<thead>
			<tr>
				<th rowspan="1">Tingkat Pendidikan</th>
				<th rowspan="1">Lembaga</th>
				<th colspan="1">Jurusan</th>				
				<th colspan="1">Tahun</th>				
			</tr>			
		</thead>
		<tbody>
		<?php foreach($riwayat_pendidikan as $r) :?>
			<tr>
				<td><?php echo $r->tingkat_pendidikan ?></td>
				<td><?php echo $r->lembaga_pendidikan ?></td>
...
<div id="dasar_sk">
<fieldset>
	<h3><strong>DASAR PENCANTUMAN GELAR</strong></h3>
	<?php if(isset($daftar_sk)): ?>	
	<table class="table striped">
		<thead>
			<tr>
		...
		<tbody>
		<?php foreach($daftar_sk as $r) :?>
			<tr>
				<?php if($r->id_sk == $this->input->get('ids')): ?>
				<td><?php echo anchor('pencantuman_gelar/registrasi/'.$pegawai->id_pegawai.'?ids='.$r->id_sk.'#dasar_sk', "<strong>".$r->nama_sk."</strong>") ?></td>
				<?php else: ?>
				<td><?php echo anchor('pencantuman_gelar/registrasi/'.$pegawai->id_pegawai.'?ids='.$r->id_sk.'#dasar_sk', $r->nama_sk) ?></td>
				<?php endif; ?>
	...
	<table class="table span10">		
		...
		<tr>
			...
			<td>
				<div class="input-control text span2">
				<input type="text" name="txtTanggalDasarSk" placeholder="yyyy-mm-dd" value="<?php if(isset($dasar_sk)) echo $dasar_sk->tgl_sk;  ?>" />
				<div>
			</td>
		</tr>
		<tr>
			...
			<td>
				<div class="input-control text span2">
				<input type="text" name="txtTmtDasarSk" placeholder="yyyy-mm-dd" value="<?php if(isset($dasar_sk)) echo $dasar_sk->tmt;  ?>" />		
				</div>
			</td>
		</tr>		
		<tr>
		...
		<tr>
			...
			<td>
				<!-- <div class="input-control text span4"> -->
				<input type="text" name="makerDasarTahun" value="<?php echo $ket[1]  ?>" /> Tahun 
				<input type="text" name="makerDasarBulan" value="<?php echo $ket[2] ?>" /> Bulan</td>
				<!-- </div> -->
		</tr>
		<tr>
	...
	<table class="table">		
			...
			<td>
				...
				<div class="row">
					<div class="input-control text span1">
						<input type="text" name="makerTahun" value="<?php echo $ket[1]  ?>" /> 
					</div>Tahun  
					<div class="input-control text span1">
						<input type="text" name="makerBulan" value="<?php echo $ket[2] ?>" />  
					</div>Bulan 
		...
		<tr>
			...
			<td>		
				...
				<strong><span id="labelGaji" ></span></strong> <button id="btnGaji" class="button info fg-white"><i class="icon-loop"> </i> Refresh gaji</button>
			</td>
		</tr>
	</table>
</fieldset>

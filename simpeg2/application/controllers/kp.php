...
class Kp extends CI_Controller {
	...
	public function index(){
		...
		//echo "kenaikan pangkat";
	}
	
	public function index2($status = NULL)
	{	
		if(is_null($status)){			

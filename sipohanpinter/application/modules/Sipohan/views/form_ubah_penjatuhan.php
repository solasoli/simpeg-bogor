  ...
  <div class="row">
    <div class="cell-12">
      ...
      <div class="form-group">
        ...
        <input type="number" data-role="input" id="ayat" name="ayat" placeholder="ayat">
      </div>
      <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" name="pangkat_pejabat" id="pangkat_pejabat" />
    </div>
    <div class="form-group">
      <label>Jabatan</label>
    ...
    <div class="form-group">
      ...
      <input type="text" name="unit_kerja_pejabat" id="unit_kerja_pejabat"/>
    </div>

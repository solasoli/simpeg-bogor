<div class="container">
<div class="row">
  <h1>Daftar Proses Acara Pemeriksaan <a class="button primary" onclick="Metro.dialog.open('#addPanggilan')"><span class="mif-add"></span></a></h1>
  <div class="cell-12">
      ...
      <td><!-- button class="button primary"
          ...
          <div class="split-button">
              ...
              <ul class="d-menu" data-role="dropdown">
                  <li><a href="#" onclick='openDialogBAP(<?php echo $jsonPegawai ?>)'>detail</a></li>
...
<div class="dialog primary" data-role="dialog" id="dialogBAP" data-close-button="true">
    ...
    <div class="dialog-actions">
        ...
        <span id="linkBAPResult"></span>
        <span id="linkUncooperatedReport"></span>
        <span id="linkCooperatedReport"></span>
    </div>
  </div>

  <script>

  function openDialogBAP(pegawai){
    console.log(pegawai);
    $("#linkBAPResult").html("<a href='<?php echo site_url('bap/result/') ?>"+pegawai.idhukuman_pemeriksaan+"' target='_blank'>cetak BAP</a>");
    $("#linkUncooperatedReport").html("<a href='<?php echo site_url('bap/uncooperated_report/') ?>"+pegawai.idhukuman_pemeriksaan+"' target='_blank'>Laporan BAP</a>");
    $("#linkCooperatedReport").html("<a href='<?php echo site_url('bap/uncooperated_report/') ?>"+pegawai.idhukuman_pemeriksaan+"' target='_blank'>Laporan BAP</a>");

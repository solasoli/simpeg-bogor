...
mysqli_connect("simpeg.db.kotabogor.net","simpeg", "Madangkara2017"); mysqli_select_db("simpeg_20141231"); 
$mysqli = new mysqli("localhost","root","koplak123","simpeg_20141231");
extract($_POST);
extract($_GET);

?>
<div class="well">
	<a class="btn btn-small" target="_blank" href="duk_print2014.php?id=<?php echo $_POST[id_unit_kerja]; ?>"><i class="icon-print"></i> Cetak</a>
	<a class="btn btn-small" target="_blank" href="eksporduk2014.php?id_unit_kerja=<?php echo $id_unit_kerja; ?>"><i class="icon-download-alt"></i> Download Ke Exel</a>
</div>
<?php
    ...
    <?php while ($row = $result->fetch_array()): ?>
		<tr class="table-small">
			...
			*/
			...
			echo("$paksa[1]");
			?></td>
			<td><?php 	$qj=mysqli_query($mysqli,"select tmt from sk where id_pegawai=$paksa[2] and id_kategori_sk=10 and id_j=$paksa[3]");

...
<script>
	$(document).ready(function(){
		...
		$("#btn2b").click(function(){
			...
			$("#3").removeClass('hide');
			$("#3").show();
			//$("#peta").html("<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15853.743729361557!2d106.78862964999999!3d-6.59261515!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69c42df2b28335%3A0xd3de424537b5fbc7!2sSMK+NEGERI+3+BOGOR!5e0!3m2!1sen!2sid!4v1412645723246" width="600" height="450" frameborder="0" style="border:0"></iframe>");

...
$(function () {
    $('#bid').highcharts({
        ...
        title: {
			...
			{
			$where = " inner join pegawai on pegawai.id_pegawai=pendidikan_terakhir.id_pegawai inner join current_lokasi_kerja on pegawai.id_pegawai = current_lokasi_kerja.id_pegawai  inner join unit_kerja on unit_kerja.id_unit_kerja=current_lokasi_kerja.id_unit_kerja where flag_pensiun=0 and id_skpd =$unit[0]  ";
			}
			else

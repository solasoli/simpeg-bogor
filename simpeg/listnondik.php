...
<h2>DAFTAR PEGAWAI YANG BELUM MEMILIKI DATA DIKLAT PADA <br><?php echo $unit_kerja->get_unit_kerja($unit['id_skpd'])->nama_baru ?><a href="#" class="btn btn-primary  hidden-print pull-right" onclick="window.print()">cetak</a></h2>
...
<table id="list_pegawai" cellspacing="0" width="100%" class="display table table-striped">
	...
	<tbody>
		<?php
			...
			$qcek=mysqli_query($mysqli,"select count(*) from  diklat where id_pegawai=$bata[0] and id_jenis_diklat=3");

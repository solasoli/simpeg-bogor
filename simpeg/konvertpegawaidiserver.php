...
$_SESSION['table'] ='temporar_pegawai'; //table name buat dulu tablenya di server dengan segala atributnya
$_SESSION['csvname']='./backuppegawaidarihosting/pegawai.csv';//tempat penyimpanan hasil bakupan dari hosting

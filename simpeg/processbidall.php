...
$qcp=mysqli_query($mysqli,"select 
				nama,
				...
				where flag_pensiun=0  and id_bidang=$bidang[0] and pendidikan_terakhir.level_p<7 
				group by pegawai.id_pegawai order by pendidikan_terakhir.tingkat_pendidikan desc");

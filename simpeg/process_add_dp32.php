...
if(!$_POST[upload_only])
{
	...
	$qInsertDp3 = "INSERT INTO dp3
					...
					(
						...
						'$_POST[nama_penilai]',
						'$_POST[nip_penilai]',
						'$_POST[pangkat_gol_penilai]',
						'$_POST[jabatan_penilai]',
						'$_POST[unit_kerja_penilai]',
						'$_POST[nama_atasan_penilai]',
						'$_POST[nip_atasan_penilai]',
						'$_POST[pangkat_gol_atasan_penilai]',
						'$_POST[jabatan_atasan_penilai]',
						'$_POST[unit_kerja_atasan_penilai]',
						'$_POST[keberatan]',
						'$_POST[tanggapan_pejabat_penilai]',
						'$_POST[keputusan_atasan_penilai]',
						'$_POST[lain_lain]',
						'$_POST[nilai_a]',
						'$_POST[nilai_b]',
						'$_POST[nilai_c]',

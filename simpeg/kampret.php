...
jabatan like '%kepala dinas%' or jabatan like '%kepala badan%' or jabatan like '%kepala kantor%' or jabatan like 'sekretaris dprd%' or jabatan like 'inspektur kota%' or jabatan like 'camat%' or jabatan like 'lurah%' or jabatan like 'kepala satuan%' or jabatan like 'sekretaris korpri%' )order by level");
	 ...
	 //echo("select id_pegawai,nama from pegawai inner join jabatan on jabatan.jabatan=pegawai.jabatan where eselon = '$dat[2]' and flag_pensiun=0");
	   ...
	   ?></td></tr></table>
        ...
        <br />
            ...
            </div> </td></tr> <tr  ><td valign="top" align="left"><img src="./images/maneh.gif" /> </td><td width="250" valign="top" align=center><img src="images/bottom.gif" /><img src="images/tengah.gif" /> </td><td><img src="./images/knaan.gif" /></td></tr>
...
//sekretaris badan,sekretaris dinas,sekretaris camat, seklur, kasubag TU 
	 ...
	 $qn=mysqli_query($mysqli,"select count(*) from jabatan where id_unit_kerja=$u and jabatan not like 'sekretaris%' and jabatan not like 'Kasubag Tata Usaha%' and (level=$lev or level=$lev2) and jabatan not like '%Staf Ahli%'");
...
echo("</select></td><td valign=bottom>  </td><td> </td></tr><tr  ><td valign=top><img src=./images/gigirki2.gif /></td><td width=250 valign=top ><img src=images/bottom.gif /> </td><td valign=bottom></td><td>&nbsp;&nbsp;&nbsp;</td> </tr><tr><td valign=top align=right><img src=./images/gigirki2.gif /><img src=./images/gigirki2.gif /> </td><td align=right valign=bottom>  $boy </td><td align=left valign=bottom> $boi  </td>  </tr></table></td>     </tr><tr><td  colspan=$kolom[0] align=center valign=top><table cellpadding=0  cellspacing=0 border=0>");





$qas=mysqli_query($mysqli,"select jabatan,eselon from jabatan where id_bos=$sek2[2]");
...
$qka=mysqli_query($mysqli,"select jabatan,eselon from jabatan where id_bos=$sisa[3]");
...
$j++;
	...
	<tr> <td align="center" valign="top" <? echo("colspan=$kolom[0]"); ?> > <div align="center"><?

	

	if($u==1 or $u==19 or  $u==23 or  $u==25 or  $u==27 or  $u==28  )
                ...
                <div align="center">
                  ...
                  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      ...
                      <td><div align="center"><a href="" >UPTD pada dinas <?  echo($nama[0]); ?> </a>

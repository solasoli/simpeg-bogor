...
$q1=mysqli_query($mysqli,"select id_unit_kerja,nama from current_lokasi_kerja inner join pegawai on pegawai.id_pegawai=current_lokasi_kerja.id_pegawai where current_lokasi_kerja.id_pegawai=$ata[id_pegawai]");
...
?>
<form action="index2.php" method="post" name="form1" class="hurup" id="form1">
...
?>
        ...
        <table width="100%" border="0" cellpadding="3" cellspacing="0" class="hurup">
          <tr>
            ...
            <td>&nbsp;</td>
            <td width="233" colspan="3" rowspan="22" align="left" valign="bottom">&nbsp;</td>
          </tr>
          <tr>
            <td width="166" align="left" valign="top">Nama </td>
            <td width="18" align="left" valign="top">:</td>
            <td width="380"><label for="n"></label>
            <input disabled="disabled" name="n" type="text" id="n" value="<? echo($kuta[1]); ?>" size="35" /></td>
          </tr>
          <tr>
            <td align="left" valign="top">NIP Lama</td>
            <td align="left" valign="top">:</td>
            <td><input disabled="disabled" name="nl" type="text" id="nl" value="<? echo($kuta['nip_lama']); ?>" /></td>
          </tr>
          <tr>
            <td align="left" valign="top" nowrap="nowrap">Agama</td>
            <td align="left" valign="top">:</td>
            <td><select disabled="disabled" name="a" id="a">
              <?
          ...
          <tr>
            ...
            <td align="left" valign="top">:</td>
            <td><select disabled="disabled"  name="jk" id="jk">
              <?
          ...
          <tr>
            ...
            <td align="left" valign="top">:</td>
            <td><input disabled="disabled" name="tl" type="text" id="tl" value="<? echo($kuta['tempat_lahir']); ?>" /></td>
          </tr>
          <tr>
            <td align="left" valign="top" nowrap="nowrap">Tanggal Lahir</td>
            <td align="left" valign="top">:</td>
            <td><label for="tgl"></label>
            <input disabled="disabled" name="tgl" type="text" class="tcal"  id="tgl" value="<? 
          ...
          <tr>
            ...
            <td align="left" valign="top">:</td>
            <td><input disabled="disabled" name="nb" type="text" id="nb" value="<? echo($kuta['nip_baru']); ?>" size="22" /></td>
          </tr>
          <tr>
            <td align="left" valign="top" nowrap="nowrap">Kartu Pegawai</td>
            <td align="left" valign="top">:</td>
            <td><input disabled="disabled" name="karpeg" type="text" id="karpeg" value="<? echo($kuta['no_karpeg']); ?>" /></td>
          </tr>
          <tr>
            <td align="left" valign="top" nowrap="nowrap">NPWP</td>
            <td align="left" valign="top">:</td>
            <td><input disabled="disabled" name="npwp" type="text" id="npwp" value="<? echo($kuta['NPWP']); ?>" /></td>
          </tr>
          <tr>
            <td align="left" valign="top" nowrap="nowrap">Gol / Ruang</td>
            <td align="left" valign="top">:</td>
            <td><select disabled="disabled" name="gol" id="gol">
              <?
          ...
          <tr>
            ...
            <td><label for="jenjab"></label>
              <select disabled="disabled" name="jenjab" id="jenjab">
              <?
          ...
          <tr>
            ...
            <td align="left" valign="top">:</td>
            <td><input disabled="disabled" name="telp" type="text" id="telp" value="<? echo($kuta['telepon']); ?>" /></td>
          </tr>
          <tr>
            <td align="left" valign="top" nowrap="nowrap">Ponsel</td>
            <td align="left" valign="top">:</td>
            <td><input disabled="disabled" name="hp" type="text" id="hp" value="<? echo($kuta['ponsel']); ?>" /></td>
          </tr>
          <tr>
            <td align="left" valign="top" nowrap="nowrap">Email</td>
            <td align="left" valign="top">:</td>
            <td><input disabled="disabled" name="email" type="text" id="email" value="<? echo($kuta['email']); ?>" /></td>
          </tr>
          <tr>
            <td align="left" valign="top" nowrap="nowrap">Alamat
            <input disabled="disabled" name="id2" type="hidden" id="id2" value="<? echo($od);  ?>" />
            <input disabled="disabled" name="id" type="hidden" id="id" value="<? echo($od);  ?>" />
            <input name="x" type="hidden" id="x" value="fox.php" />
            <input  name="od" type="hidden" id="od" value="<? echo("$od");  ?>" /></td>
            <td align="left" valign="top">:</td>
            <td><textarea disabled="disabled" class="hurup" name="al" id="al" cols="45" rows="3"><? echo($kuta['alamat']); ?></textarea></td>
          </tr>
          <tr>
            <td align="left" valign="top" nowrap="nowrap">Kota</td>
            <td align="left" valign="top">:</td>
            <td><input disabled="disabled" name="kota" type="text" id="kota" value="<? echo($kuta['kota']); ?>" /></td>
          </tr>
          <tr>
            <td align="left" valign="top" nowrap="nowrap">Golongan Darah</td>
            <td align="left" valign="top">:</td>
            <td><select disabled="disabled" name="darah" id="darah">
              <?
          ...
          <tr>
            ...
            <td align="left" valign="top">:</td>
            <td><input disabled="disabled" name="pensiun" type="text" class="tcal"  id="pensiun" value="<? 
  ...
  <div class="TabbedPanelsContent">
      <table width="100%" border="0" cellpadding="3" cellspacing="0" class="hurup">
		...
		while($pen=mysqli_fetch_array($qp))
		{
          ...
          <td>$j</td>
          <td>"); ?>
          <select disabled="disabled" name="tp<? echo($j); ?>" id="tp<? echo($j); ?>">
            <?
			  $qjo2=mysqli_query($mysqli,"SELECT tingkat_pendidikan FROM `pendidikan` where tingkat_pendidikan!=' '   group by tingkat_pendidikan ");
				...
				echo("<option disabled value=$otoi2[0] selected>$otoi2[0]</option>");
				else
				echo("<option disabled value=$otoi2[0]>$otoi2[0]</option>");
				}
		 ...
		 echo("</td>
          <td><input disabled  type=text name=lem$j id=lem$j value='$pen[2]' /></td>
          <td><input disabled  type=text name=jur$j id=jur$j value='$pen[4]' /></td>
          <td><input disabled  type=text name=lus$j id=lus$j value='$pen[5]' /> <input type=hidden name=idpen$j id=idpen$j value=$pen[0] /></td>
        </tr>");
        ...
        <tr>
          <td>+</td>
          <td><select disabled="disabled" name="tingkat" id="tingkat">
            <?
			  $qjo2=mysqli_query($mysqli,"SELECT tingkat_pendidikan FROM `pendidikan` where tingkat_pendidikan!=' '   group by tingkat_pendidikan ");
                while($otoi2=mysqli_fetch_array($qjo2))
            ...
            <input disabled="disabled" name="totalpen" type="hidden" id="totalpen" value="<? echo($totpen); ?>" /></td>
          <td><label for="lembaga"></label>
            <input disabled="disabled" type="text" name="lembaga" id="lembaga" /></td>
          <td><input disabled="disabled" type="text" name="jurusan" id="jurusan" /></td>
          <td><input disabled="disabled" type="text" name="lulusan" id="lulusan" /></td>
          </tr>
      </table>
    </div>
        <div class="TabbedPanelsContent">
          <table width="100%" border="0" cellpadding="3" cellspacing="0" class="hurup">
            <tr>
              <td>Status Nikah</td>
              <td>:</td>
              <td><select disabled="disabled" name="kawin" id="kawin">
                <?
            ...
            <tr>
              ...
              <td><label for="win"></label>
                <input disabled="disabled" name="win" type="text" id="win" value="<? echo($kuta['nama_istri']); ?>" size="30" /></td>
            </tr>
            <tr>
              <td nowrap="nowrap">Tempat lahir istri/suami</td>
              <td>:</td>
              <td><input disabled="disabled" name="twin" type="text" id="twin" value="<? echo($kuta['tempat_lahir_istri']); ?>" size="30" /></td>
            </tr>
            <tr>
              <td nowrap="nowrap">Tanggal Lahir istri/suami</td>
              <td>:</td>
              <td><input disabled="disabled" name="tglwin" type="text" class="tcal"  id="tglwin" value="<? 
		  ...
		  ?>
			...
			$th5=substr($acoy[4],0,4);
				echo("<tr>
				<td> $i</td>
              <td><input disabled  type=text name=anak$i id=anak$i value='$acoy[2]' size=25 /> </td>
			  <td><input disabled  type=text name=la$i id=la$i value='$acoy[3]' size=15 /> </td>
              <td><input disabled  type=text name=tg$i id=tg$i value=$t5-$b5-$th5 class=tcal  /> <input type=hidden name=king$i id=king$i value=$acoy[0]   /> </td>
           </tr>");
				$i++;
			}
			$totanak=$i-1;
			?>
                  <tr>
                    <td><input disabled="disabled" name="ja" type="hidden" id="ja" value="<? echo($totanak);  ?>" />
                      +</td>
                    <td><label for="anak"></label>
                      <input disabled="disabled" type="text" name="anak" id="anak" size="25"/></td>
                    <td><label for="ttl"></label>
                      <input disabled="disabled" type="text" name="ttl" id="ttl"  size="15"/></td>
                    <td><input disabled="disabled" name="tlanak" type="text" class="tcal"  id="tlanak"  size="20"/></td>
                  </tr>
              </table></td>
			...
			while($cu=mysqli_fetch_array($qsk))
			{
              ...
              <td><input type=text name=tmsk$k id=tmsk$k value=$tsk2-$bsk2-$thsk2 class=tcal size=8 /></td>
			    <td nowrap> <input type=text name=sah$k id=sah$k value='$cu[6]' size=27 class=hurup /> </td>
				  <td nowrap> <input type=text name=beri$k id=beri$k value='$cu[5]' size=27 class=hurup />

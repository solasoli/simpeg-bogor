<div class="navbar">
  <div class="navbar-inner">
    <a class="brand" href="#">DAFTAR URUT KEPANGKATAN (DUK) STRUKTURAL</a>    
  </div>
</div>
<?php
include("konek.php");
...
<?php if($_SESSION['id_pegawai'] == 4314 ): ?>
...
$(document).ready(function(){
	...
	$("#btnDisplay").click(function(){
		...
		$.post("duk_displaystruk.php", {id_unit_kerja : $("#id_skpd").val()}, function(data){
			$("#container").html(data);
		});
	});

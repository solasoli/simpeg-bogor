...
<tr>
    ...
    <td>Surat Pengantar dari Unit Kerja <i>
            <small>( pdf / jpg )</small>
        </i>
    ...
    <td align="left">
        ...
        <div id="progress1" class="progress primary">
            <div class="progress-bar progress-bar-primary">
                ...
                $qc22 = mysqli_query($mysqli,"select b.id_berkas, ib.file_name from berkas b, isi_berkas ib where b.id_berkas = ib.id_berkas AND b.id_pegawai=$idp and b.id_kat=21 and b.ket_berkas like '$ket' ");

                $cek22 = mysqli_fetch_array($qc22);
                mysqli_query($mysqli,"update ijin_belajar set spuk=$cek22[0] where id=$ij[0]");
                echo("<a href='/Simpeg/Berkas/$cek22[1]' target='_blank' >Syarat Sudah Tersedia</a>");
                echo("<input type=hidden name=s1 id=s1 value=1 />");
                echo("  <input type=\"button\" name=\"button\" id=\"btnReupload1\" value=\"Upload Ulang\" onclick=\"toggle_fileReupload('fileReupload1', 'btnReupload1');\" />");
                ?>
                <div id="fileReupload1">
              <span class="btn btn-primary btn-sm fileinput-button">
            <i class="glyphicon glyphicon-plus"></i>
            <span>Pilih File</span>
            <!-- The file input field used as target for the file upload widget -->
...
<tr>
    ...
    <td>Surat Pernyataan yang Ditandatangani oleh Atasan Langsung <i>
            <small>( pdf / jpg )</small>
        </i></td>
    <td align="left">
        ...
        <div id="progress2" class="progress primary">
            <div class="progress-bar progress-bar-primary">
                ...
                $qc33 = mysqli_query($mysqli,"select b.id_berkas, ib.file_name from berkas b, isi_berkas ib where b.id_berkas = ib.id_berkas AND b.id_pegawai=$idp and b.id_kat=22 and b.ket_berkas like '$ket' ");

                $cek33 = mysqli_fetch_array($qc33);

                mysqli_query($mysqli,"update ijin_belajar set spal=$cek33[0] where id=$ij[0]");
                echo("<a href='/Simpeg/Berkas/$cek33[1]' target='_blank' >Syarat Sudah Tersedia</a>");
                echo("<input type=hidden name=s2 id=s2 value=1 />");
                echo("  <input type=\"button\" name=\"button\" id=\"btnReupload2\" value=\"Upload Ulang\" onclick=\"toggle_fileReupload('fileReupload2', 'btnReupload2');\" />");
                ?>
                <div id="fileReupload2">
              <span class="btn btn-primary btn-sm fileinput-button">
            <i class="glyphicon glyphicon-plus"></i>
            <span>
            Pilih File</span>
...
<tr>
    ...
    <td>DP3 / Penilaian Prestasi Kerja Tahun Terakhir <i>
            <small>( pdf / jpg )</small>
        </i></td>
    <td align="left">
        <?php
...
<tr>
    ...
    <td>Ijazah Pendidikan Terakhir <i>
            <small>( pdf / jpg )</small>
        </i></td>
    <td align="left">
        <?php
        ...
        <div id="progress5" class="progress primary">
            <div class="progress-bar progress-bar-primary">
                <?php
                    ...
                    //echo("select p.id_berkas, ib.file_name from pendidikan p, isi_berkas ib where p.id_berkas = ib.id_berkas AND p.id_pegawai=$idp and p.id_berkas>0 and p.level_p=$curtp ");
...
<tr>
    ...
    <td>Surat Keterangan Diterima / Masih Kuliah dari Perguruan Tinggi <i>
            <small>( pdf / jpg )</small>
        </i></td>
    <td align="left">
...
<tr>
    ...
    <td>Jadwal Perkuliahan Yang Masih Berlaku <i>
            <small>( pdf / jpg )</small>
        </i></td>
    <td align="left">
...
if ($name[2] == 'Guru') {
    ...
    <tr>
        ...
        <td>Jadwal Mengajar di Sekolah yang Bersangkutan (Khusus Guru) <i>
                <small>( pdf / jpg )</small>
            </i></td>
        <td align="left">
            ...
            <div id="progress8" class="progress primary">
                <div class="progress-bar progress-bar-primary">
                    <?php
                        ...
                        $qc88 = mysqli_query($mysqli,"select b.id_berkas, ib.file_name from berkas b, isi_berkas ib where b.id_berkas = ib.id_berkas and b.id_pegawai=$idp and b.id_kat=25 and b.ket_berkas like '$ket' ");
                        $cek88 = mysqli_fetch_array($qc88);

                        mysqli_query($mysqli,"update ijin_belajar set jm=$cek88[0] where id=$ij[0]");
                        echo("<a href='/Simpeg/Berkas/".basename($cek88[1])."' target='_blank' >Syarat Sudah Tersedia</a>");
                        echo("<input type=hidden name=s8 id=s8 value=1 />");
                    echo("  <input type=\"button\" name=\"button\" id=\"btnReupload8\" value=\"Upload Ulang\" onclick=\"toggle_fileReupload('fileReupload8', 'btnReupload8');\" />");
                    ?>
                    <div id="fileReupload8">
              <span class="btn btn-primary btn-sm fileinput-button">
            <i class="glyphicon glyphicon-plus"></i>
            <span>
            Pilih File</span>
        ...
        <td align="left">
           ...
           <input type="hidden" name="s9" id="s9"/>  </span>
        	 ...
        	 <?php
                ...
                $qc99 = mysqli_query($mysqli,"select b.id_berkas, ib.file_name from berkas b, isi_berkas ib where b.id_berkas = ib.id_berkas and b.id_pegawai=$idp and b.id_kat=26 and b.ket_berkas like '$ket' ");

                $cek99 = mysqli_fetch_array($qc99);

                mysqli_query($mysqli,"update ijin_belajar set kkg=$cek99[0] where id=$ij[0]");
                echo("<a href='/Simpeg/Berkas/".basename($cek99[1])."' target='_blank' >Syarat Sudah Tersedia</a>");
                echo("<input type=hidden name=s9 id=s9 value=1 />");
             echo("  <input type=\"button\" name=\"button\" id=\"btnReupload9\" value=\"Upload Ulang\" onclick=\"toggle_fileReupload('fileReupload9', 'btnReupload9');\" />");
             ?>
             <div id="fileReupload9">
              <span class="btn btn-primary btn-sm fileinput-button">
            <i class="glyphicon glyphicon-plus"></i>
            <span>
            Pilih File</span>

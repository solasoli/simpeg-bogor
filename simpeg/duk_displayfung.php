...
?>
<div class="well">
	<a class="btn btn-small" target="_blank" href="duk_print_fung.php?id=<?php echo $_POST[id_unit_kerja]; ?>"><i class="icon-print"></i> Cetak</a>
	<a class="btn btn-small" target="_blank" href="ekspordukfung.php?id_unit_kerja=<?php echo $id_unit_kerja; ?>"><i class="icon-download-alt"></i> Download Ke Exel</a>
</div>
<?php
...
if($id_unit_kerja)
{
$result = $mysqli->query("CALL PRC_VIEW_DUKFUNG($id_unit_kerja)");
$i = 1;
if($result):?>

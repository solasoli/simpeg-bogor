...
<head>
	...
	<title>Daftar Urutan Kepangkatan::SIMPEG</title>
...
$(document).ready(function(){
	...
	$("#btnDisplay").click(function(){
		...
		if(id_skpd == 0){
			...
			$.post("duk_show.php", {id_skpd : null }, function(data){
				$("#content").html(data);
			});
		}else{
			...
			if(id_unit_kerja == 0){
				$.post("duk_show.php", {id_skpd : $("#skpd").val() }, function(data){
					$("#content").html(data);
				});
			}else{
				$.post("duk_show.php", {id_skpd : id_skpd, 

				...
				<div class="row">
					<div class="col-md-6">
							<div class="form-group">
								<label for="orientasipelayanan" class="col-sm-6 control-label">Orientasi Pelayanan</label>
								<div class="col-sm-6">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="txt" class="form-control" name="kepemimpinan"
										<?php
											$obj_p = $obj_pegawai->get_obj($_GET['idp']);
											echo (isset($obj_p->id_j) || $obj_p->is_kapus == 1) ? "" : "readonly"; 

										?> id="inputKepemimpinan" value="<?php echo $perilaku->kepemimpinan ?>">
...
<script>
	...
	$("#btnPerilaku").on("click",function(){
		...
		orientasipelayanan = $("#orientasipelayanan").val();
		integritas = $("#inputIntegritas").val();
		komitmen = $("#inputKomitmen").val();
		disiplin = $("#inputDisipilin").val();
		kerjasama = $("#inputKerjasama").val();

		if(orientasipelayanan < 76 ||
			integritas < 76 ||
			komitmen < 76 ||
			disiplin < 76 ||
			kerjasama < 76){

				var r = confirm("Nilai yang anda berikan kurang dari 76 \n yakin untuk menyimpan ?!");
				if (r == true) {

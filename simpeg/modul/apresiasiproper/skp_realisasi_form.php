...
<nav aria-label="breadcrumb">
	<ol class="breadcrumb">
		<li class="breadcrumb-item"><a href="index.php?page=list">Daftar PPK3</a></li>
		...
		<table class="clearfix table table-bordered">
			...
			<tr >
				...
				<td style="padding-right:0px" class="hidden-print">
					...
					<a data-toggle="tooltip" title="reset penghitungan dan nilai capaian SKP" onclick="reset_penghitungan(<?php echo $target->id_skp_target ?>)" class="btn btn-danger btn-xs hidden btn-revisi">reset</a>
				</td>
				<?php } ?>
			</tr>
			<?php } ?>

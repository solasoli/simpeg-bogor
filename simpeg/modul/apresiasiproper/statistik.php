...
$(document).ready(function() {
   $('#gol_stat').highcharts({
        ...
        title: {
            text: 'Statistik Hasil Proyek Perubahan per tahun'
        },
		xAxis:{
			title: {
				text: 'Tahun'
...
<div class="row">
	<div class="col-md-4">
		<?php include('statistik_status.php') ?>
	</div>
	<div class="col-md-4">
		<?php include('statistik_status_menengah.php') ?>
	</div>
	<div class="col-md-4">
		<?php include('statistik_status_panjang.php') ?>
	</div>
</div>

<div class="panel panel-default">
	<div class="panel-heading hidden-print">
		<div class="panel-title">
			<h5>Daftar Penilaian SKP Gabungan</h5>
		</div>
	</div>
	...
	<div class="panel-body">
		<table class="clearfix table table-bordered" id="listskp">
			...
			<tbody>
				<?php
					$list_skp = $skp->get_tahun_skp($pegawai->id_pegawai);
					$x=1;
				...
				<tr>
					<td><?php echo $x++; ?>.</td>
					<td><?php echo $each_skp->tahun ?></td>					
					
					<td class="hidden-print">
						<a href="index.php?page=gabungan&y=<?php echo $each_skp->tahun ?>" class="btn btn-primary btn-xs">lihat</a>

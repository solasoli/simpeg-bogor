 ...
 <div class="panel-group hidden-print" id="accordion">
				...
				<table class="table">
					...
					<tr>
						<td>
							...
							<span class="glyphicon glyphicon-wrench text-primary"></span><a target="_blank" href="<?php echo 'http://' . $_SERVER['HTTP_HOST'] .'/pengaturan/index.php/admin/skp/'.$_SESSION['id_skpd'] ?>"> Pengaturan</a>
						</td>
					</tr>
					<?php //} ?>
					<tr>
					...
					<tr>
						<td>
							<span class="glyphicon glyphicon-search text-primary"></span><a href="index.php?page=statistik"> Statistik</a>
						</td>
					</tr>
					<tr>
						<td>
	...
	<div class="panel panel-default">
		...
		<div id="collapseOne" class="panel-collapse collapse">
          ...
          <tr>
            <td>
              <span class="glyphicon glyphicon-pencil text-primary"></span><a href="index.php?page=list&t=final&idp=<?php echo $pegawai->id_pegawai ?>"> Daftar Penilaian Prestasi Kerja</a>
            </td>
          </tr>
          <tr>
						<td>

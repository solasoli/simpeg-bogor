...
$qo = mysql_query ("select DISTINCT
            ...
            left join current_lokasi_kerja c on c.id_pegawai = p.id_pegawai
             ...
             (select b.id_pegawai, b.nama,
              ...
              where flag_pensiun = 0 and u.id_skpd = 4789
...
<table id="rekap_skp" class="table table-bordered display" cellspacing="0" width="100%">
	<thead>
		<tr>
			<th>Id Pegawai</th>
			<th>Nama</th>
...
while($bata=mysql_fetch_array($qo)){
  ...
  ?>
    <tr>
      ...
      <td><?php echo $nilai_skp = round($skp->get_nilai_capaian_rata2($bata["id_pegawai"], 2017),2) ?> </td>
      <td><?php echo $rata2_perilaku = number_format($lastSkp->rata2_perilaku,2) ?></td>

...
<nav aria-label="breadcrumb">
	<ol class="breadcrumb">
		<li class="breadcrumb-item"><a href="index.php?page=list">Daftar PPK2</a></li>
				...
				<div class="row">
					<div class="col-sm-11">
						<form role="form" class="form-horizontal" id="formTambahUraian">
							...
							if($pegawai->jabatan == 'Guru' and $pegawai->jenjab == 'Fungsional'){ ?>
							...
							<?php } ?>
              <?php if($pegawai->jenjab == 'Struktural') {?>
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select class="form-control" id="stk_skp">
                    <option></option>
                    <?php
                      $stk = $skp->get_stk($pegawai->id_jfu,'PELAKSANA');

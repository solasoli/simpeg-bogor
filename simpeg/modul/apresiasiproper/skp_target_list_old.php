					...
					<div class="table-responsive">						
						<table class="table table-bordered">							
							...
							<tr>
								<td></td>
								<td>Pangkat/Gol</td>
								<td><?php echo $penilai->golongan ?></td>
								<td></td>
								<td>Pangkat/Gol</td>
								<td><?php echo $atasan_penilai->golongan ?></td>
							</tr>
							<tr>
								<td></td>
								<td>Jabatan</td>
...
<script>
	...
	function skpbaru(idpenilai){
		...
		if(!idpenilai){
			alert("penilai tidak ditemukan, silahkan lakukan pengaturan jabatan atasan langsung terlebih dahulu");
	...
	function berikutnya(){
		...
		//alert(<?php echo $penilai->id_pegawai ?>);

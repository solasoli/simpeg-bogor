<?php
	...
	$atasan_penilai = $lastSkp->id_atasan_penilai_realisasi > 0 ? $obj_pegawai->get_obj($lastSkp->id_atasan_penilai_realisasi) : $obj_pegawai->get_obj($lastSkp->id_atasan_penilai);
	...
	<div class="col-sm-12">
		<table class="table table-bordered">
			...
			<tr>
				<td>c. Pangkat, Golongan/ruang</td>
				<td><?php
					echo isset($lastSkp->gol_penilai_realisasi)? $lastSkp->gol_penilai_realisasi : $lastSkp->gol_penilai //($penilai->pangkat." - ".$penilai->pangkat_gol
			...
			<tr>
				<td>d. Jabatan/Pekerjaan</td>
				<td><?php echo isset($lastSkp->jabatan_penilai_realisasi) ? $lastSkp->jabatan_penilai_realisasi : $lastSkp->jabatan_penilai ?></td>
			</tr>
			<tr>
				<td>e. Unit Organisasi</td>
			...
			<tr>
				...
				<td><?php
					//if
					echo ($atasan_penilai->flag_pensiun == '0' || $atasan_penilai->flag_pensiun == '1') ? $atasan_penilai->nip_baru : "-" ;
					?>
				</td>
			</tr>
			<tr>
				...
				<td>
					<?php
						if($atasan_penilai->flag_pensiun == '0' || $atasan_penilai->flag_pensiun == '1'){
							echo isset($lastSkp->gol_atasan_penilai)? $lastSkp->gol_atasan_penilai : $atasan_penilai->pangkat." - ".$atasan_penilai->pangkat_gol ;
						}else{
							echo "-";
						}
					?>
			...
			<tr>
				<td>d. Jabatan/Pekerjaan</td>
				<td><?php echo $jabAtasanPenilaiRealisasi = $lastSkp->jabatan_atasan_penilai_realisasi ? $lastSkp->jabatan_atasan_penilai_realisasi : $lastSkp->jabatan_atasan_penilai ?></td>
			</tr>
			<tr>
				<td>e. Unit Organisasi</td>
		...
		<tr>
			<td style="height:150px;vertical-align:middle" class="text-center">
				<div class="col-xs-6 col-xs-offset-6">
					9. DIBUAT TANGGAL, <?php echo ($lastSkp->tgl_pembuatan_penilaian==''?$format->tanggal_indo($lastSkp->akhir):$format->tanggal_indo($lastSkp->tgl_pembuatan_penilaian)) ?><span style="font-color:#fff"></span>
					<br>PEJABAT PENILAI,
					<br><br><br><br>
				...
				<div class="col-xs-6">
					10. DITERIMA TANGGAL, <?php echo $lastSkp->tgl_diterima ? $format->tanggal_indo($lastSkp->tgl_diterima) : "" ?>
				...
				<div class="col-xs-6 col-xs-offset-6">
					11. DITERIMA TANGGAL, <?php echo $lastSkp->tgl_diterima_atasan ? $format->tanggal_indo($lastSkp->tgl_diterima_atasan) : "" ?>
					<br>ATASAN PEJABAT YANG MENILAI,
					<br><br><br><br>
					<span <?php
						echo $atasan_penilai->flag_pensiun == '0' ? 'style="text-decoration:underline"' : '' ?>><strong><?php echo $atasan_penilai->nama_lengkap ?></strong></span>
					<?php if($atasan_penilai->flag_pensiun == '0'){ ?>

<div class="panel panel-default">
	<div class="panel-heading hidden-print">
		<div class="panel-title">
			<h5>Realisasi Penilaian Perilaku</h5>
		</div>
	</div>
	<div class="visible-print">
		<h5 class="text-center">LIST PENILAIAN PERILAKU<br> PEGAWAI NEGERI SIPIL</h5>
	</div>
			...
			<tbody>
				...
				<tr>
					...
					<td class="hidden-print">
						<a href="index.php?page=myperilaku&idskp=<?php echo $each_skp->id_skp ?>" class="btn btn-primary btn-xs">lihat</a>

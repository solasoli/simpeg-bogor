...
<?php
//$mysqli = new mysqli("127.0.0.1:3307","kominfo-skp","Madangkara2017","simpeg");
...
<div class="row-fluid">
	...
	<div class="col-md-11">
		<h2 class="simpeg-brand hidden-xs">
			...
			<br>
			<small>PENILAIAN PRESTASI KERJA PNS</small>
		</h2>
		...
		<nav class="navbar  navbar-default " role="navigation">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					<!--li><a href="#">Link</a></li-->
                    <li><a href="index.php">SKP Home</a></li>
					<!-- tim OPD Menu -->
					...
					<!-- li><a href="index.php">Sasaran Kerja</a></li -->
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							<!--span class="glyphicon glyphicon-folder-close"></span-->
							<span class="hidden-sm">Sasaran Kerja</span><b class="caret"></b>
						</a>
						<ul class="dropdown-menu">
							<li><a href="index.php?page=list&t=final&idp=<?php // echo $pegawai->id_pegawai ?>"><span class="glyphicon glyphicon-tasks"></span> Daftar Penilaian Prestasi Kerja</a></li>
							<li class="divider"></li>
							<li><a href="index.php?page=listofskp"><span class="glyphicon glyphicon-pencil"></span> Formulir Target Kerja</a></li>
							<li class="divider"></li>
							<li><a href="index.php?page=listofrealisasi"><span class="glyphicon glyphicon-flash"></span> Realisasi Target Kerja</a></li>
							<li class="divider"></li>
							<li><a href="index.php?page=listofmyperilaku"><span class="glyphicon glyphicon-book"></span> Catatan Perilaku</a></li>
							<li class="divider"></li>
							<li><a href="index.php?page=los2&t=final&idp=<?php echo $pegawai->id_pegawai ?>"><span class="glyphicon glyphicon-print"></span> Laporan & SKP gabungan</a>							</li>
							<li class="divider"></li>
							<li><a href="index.php?page=data&idp=<?php echo $pegawai->id_pegawai ?>"><span class="glyphicon glyphicon-print"></span> Ubah Data SKP</a></li>
							<li class="divider"></li>
						</ul>
					</li>
					<li class="dropdown">

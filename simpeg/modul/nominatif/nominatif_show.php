...
?>
	<a href="nominatif_show.php?q=download&id_skpd=<?php echo $_REQUEST['id_skpd'] ?>&id_unit_kerja=<?php echo $_REQUEST['id_unit_kerja'] ?>">download xls</a>
<?php
	}else{
?>
	<a href="nominatif_show.php?q=download&id_skpd=<?php echo $_REQUEST['id_skpd']?>">download xls</a>
<?php	
	}
}else{
?>
	<a href="nominatif_show.php?q=download">download xls</a>
<?php	
}
?>
	...
	<tbody>
		<?php
			...
			if(isset($_REQUEST['id_skpd']) ){
				...
				if(isset($_REQUEST['id_unit_kerja'])){					
					$result = $duk->get_nominatif($_REQUEST['id_skpd'],$_REQUEST['id_unit_kerja']);
				}else{
					$result = $duk->get_nominatif($_REQUEST['id_skpd']);
				}				
